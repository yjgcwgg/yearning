export default {
  ...
  'order.batch.check.title': 'Batch SQL Check Results',
  'order.batch.check.confirm': 'Confirm Approval',
  'order.batch.check.cancel': 'Cancel',
  'order.batch.check.fail': 'SQL check request failed',
  'order.batch.check.error': 'Error',
  'order.batch.check.warn': 'Warning',
  'order.batch.check.pass': 'Pass',
  'order.batch.check.no_issues': 'No issues found',
  'order.batch.check.has_errors': 'Some orders have warnings or errors. Confirm batch approval?',
  'order.batch.check.col.level': 'Level',
  'order.batch.check.col.error': 'Message',
  'order.batch.check.col.sql': 'SQL',
  'order.batch.check.col.affect': 'Rows',
  'order.batch.check.col.status': 'Status',

  'order.batch.rollback': 'Batch Rollback',
  'order.batch.rollback.title': 'Batch Rollback Confirmation',
  'order.batch.rollback.confirm': 'Submit Rollback',
  'order.batch.rollback.desc': 'Submitting rollback orders for {count} completed order(s):',
  'order.batch.rollback.no_sql': 'No rollback SQL',
  'order.batch.rollback.no_valid': 'No orders have rollback SQL available',
